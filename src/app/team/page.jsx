...
const page = () => {
    return (
        ...
        //                         <img className='absolute bottom-0 w-[260px] left-[9%]' src="https://edify.pk/_next/image?url=https%3A%2F%2Fres.cloudinary.com%2Fsameer-13%2Fimage%2Fupload%2Fv1705655861%2FBlog-images%2Fttot6efmron0z8hy6gyh.png&w=640&q=75" alt="" />

        //                         <svg className="rounded-2xl" width="324" height="337" viewBox="0 0 324 337" fill="none" xmlns="http://www.w3.org/2000/svg">
        //                             <path d="M36 0H268L324 337H0L36 0Z" fill="#ADD8E6" />
        //                         </svg>

        //                     </div>
        //                     <div className="text-center">
        //                         <h4 className='text-lg  cursor-pointer font-semibold'>Azeem Qasim </h4>
