...
const Courses = () => {
    return (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-6xl mx-auto px-4 ">
            ...
            <div className="bg-white shadow p-5 rounded-2xl transition-all duration-300 hover:border-primary border cursor-pointer group">
                ...
                <div className="flex justify-between items-center">
                    <div className="py-[5px] px-2  text-gray-500 rounded  sm:text-sm text-sm border  group-hover:bg-primary group-hover:text-white   cursor-default transition-all duration-300">Enroll Now</div>
            ...
            <div className="bg-white shadow p-5 rounded-2xl border">
                ...
                <div className="flex justify-between items-center">
                    <div className="py-[5px] px-2  text-gray-500 rounded  sm:text-sm text-sm border  hover:bg-primary hover:text-white   cursor-default transition-all duration-300">Enroll Now</div>
